...
namespace Inkukan.Application.Tests.Features.UserCollection.Commands.AddToUserCollection
{
    ...
    public class AddToUserCollectionCommandHandlerTests
    {
        ...
        private IBaseRepository<UserListItem> _userListRepoMock;
        private IBaseRepository<User> _userRepoMock;
        private IBaseRepository<SerieVolume> _serieVolumeRepoMock;
        private IMapper _mapper;
        private AddToUserCollectionCommandValidator _validator;
        private AddToUserCollectionCommandHandler _handler;
